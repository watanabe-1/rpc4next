...
type HasDynamicCategory = HasPath<PathStructure, ["patterns", "dynamic", "_category"]>;
type HasNestedDynamic = HasPath<PathStructure, ["patterns", "dynamic", "_category", "_item"]>;
...
type HasParallelAnalyticsPage = HasPath<PathStructure, ["patterns", "parallel", "views"]>;
type HasParallelTeamPage = HasPath<PathStructure, ["patterns", "parallel", "members"]>;
type HasPhotoCommentRoute = HasPath<PathStructure, ["photo", "_id", "comments", "_commentId"]>;
type HasPrivateFolderRoute = HasPath<PathStructure, ["patterns", "_private", "ignored"]>;
type HasEscapedUnderscoreUrlSegment = HasPath<PathStructure, ["patterns", "%5Fescaped"]>;
type HasMalformedEncodedUrlSegment = HasPath<PathStructure, ["patterns", "%E3%81%ZZ"]>;
type HasInterceptingModalBranch = HasPath<PathStructure, ["feed", "@modal"]>;
type HasInterceptingDrilldownBranch = HasPath<PathStructure, ["feed", "@drilldown"]>;
