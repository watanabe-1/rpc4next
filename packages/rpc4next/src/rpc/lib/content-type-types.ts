type KnownContentType =
  ...
  | "application/application/resolve-response+jwt"
  | "application/application/trust-chain+json"
  | "application/application/trust-mark+jwt"
  | "application/application/trust-mark-delegation+jwt"
  | "application/at+jwt"
